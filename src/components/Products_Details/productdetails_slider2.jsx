...
import styles from "./productdetails_slider2.module.css";
    ...
    <div className={styles.container}>
      ...
      <section className={styles.sliderSection}>
        <div className={styles.sliderHeader}>
          <h3 className={styles.sliderTitle}>Buy it with</h3>
      ...
      <section className={styles.sliderSection}>
        <div className={styles.sliderHeader}>
          <h3 className={styles.sliderTitle}>Customers who views this item also viewed</h3>
          {/* <div className={styles.pageControls}>
...
export default ProductDetailsSlider2;
